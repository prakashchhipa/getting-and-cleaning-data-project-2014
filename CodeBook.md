...
*  max(): Largest value within array
*  min(): Smallest value within array
...
The tidy data set contains around 10299 observations with 81 variables divided in:
...
For variables derived from mean and standard deviation estimation, the previous labels are augmented with the terms "Mean" or "Standard_Deviation".

The data set is written to the file "sensor_tidy_data_set.txt".
